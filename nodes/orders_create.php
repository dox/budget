...
<form method="POST" action="index.php?n=orders_all">
	...
	<div class="row">
		<div class="col-sm">
			<div class="form-group">
				...
				<input type="text" class="form-control" data-provide="typeahead" id="supplier" name="supplier" placeholder="Supplier" <?php if (isset($orderToClone['supplier'])) { echo "value=\"" . $orderToClone['supplier'] . "\"";}?>autocomplete="off">
			</div>
		</div>
		<div class="col-sm">
			<div class="form-group">
	...
	<div class="form-group">
		...
		<select class="form-control" readonly name="cost_centre">
			<?php
...
$(document).ready(function(){
	var data = [<?php echo implode(",", $suppliersArray);?>];
	$("#supplier").typeahead({ source:data });
});

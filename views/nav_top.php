		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<div class="btn-group btn-group-sm">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="index.php?n=costcentres_create">Create Cost Centre</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="#">Create Import</a>
				</div>
			</div>
			...
			<ul class="navbar-nav my-2 my-lg-0">
				<li class="nav-item"><a class="nav-link" href="index.php?n=logs_all" tabindex="-1" aria-disabled="true"><i class="far fa-clock"></i></a></li>
				<li class="nav-item"><a class="nav-link" href="index.php?n=user_settings" tabindex="-1" aria-disabled="true"><i class="far fa-user"></i></a></li>
			</ul>
		</div>
	</nav>
</div>
